...
export default function HomeScreen() {
  ...
  return (
    <Box sx={{display: 'flex', justifyContent: 'center', flexDirection: 'row', borderRadius: '15px', width: 'fit-content', mx: 'auto', background: 'linear-gradient(135deg, #f5f7fa,rgb(92, 96, 169))'}}>
