...
const news = [
  ...
  {id: 2, headline: 'Introducing Verified Duo Push', path: 'news/verified_duo_push', element: <RenderMarkdown markdown={news_manifest.verifiedDuoPush.md} w={'900px'}/>, info: news_manifest.verifiedDuoPush.info},
