            ...
            <Box sx={{mx: '5%'}}>
                ...
                <Box sx={{mx: {lg: '10%', xl: '20%'}, mt: '30px'}}>
                    <Grid container spacing={2} columns={{xs: 1, md: 3}}>
                        ...
                        <Grid size={{xs: 3, md: 1}}><ItemCardNoLink title='Migration from Windows 10 to Windows 11' description='Support for Windows 10 end on October 14, 2025. All of our machines will need to be upgraded to Windows 11 by this time.' /></Grid>
