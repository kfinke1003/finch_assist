export const watchguard_vpn_info = 'WatchGuard Mobile VPN allows you to access company resources from almost anywhere—provided you have an internet connection.'
